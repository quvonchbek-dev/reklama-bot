...
class BotUser(models.Model):
    ...
    last_name = models.CharField(
        max_length=255, null=True, blank=True, verbose_name='Familiya')
    username = models.CharField(max_length=255, null=True, blank=True)
    chat_id = models.CharField(unique=True, max_length=255)

    lang = models.CharField(
        max_length=2, choices=Lang.choices, default=Lang.UZ)
...
class Post(models.Model):
    ...
    type = models.CharField(
        max_length=5, choices=PostType.choices, default=PostType.PHOTO)
